...
```py fee_delegated_smart_contract_deploy_sign_recover.py focus=

```
---

Connect to the Klaytn Baobab testnet
...
Create sender and fee payer accounts from the private key


```py fee_delegated_smart_contract_deploy_sign_recover.py focus=15:16

```
---

Create an empty fee-delegated smart contract deployment transaction


```py fee_delegated_smart_contract_deploy_sign_recover.py focus=18:23
...
Recover the fee payer address from the signed transaction
...
```py fee_delegated_smart_contract_deploy_sign_recover.py focus=41:43
