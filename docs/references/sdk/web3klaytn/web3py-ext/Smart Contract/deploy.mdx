...
---
Import necessary utils from web3py
```py smart_contract_deploy.py focus=1:4

```
---
Define an account list from private key for next step
```py smart_contract_deploy.py focus=6:7

```
---
Connect to web3, use middleware construct_sign_and_send_raw_middleware for sending raw transaction without signing
```py smart_contract_deploy.py focus=8:9

```
---
Initialize a Web3 contract instance with bytecode and ABI

```py smart_contract_deploy.py focus=34:37

```
---
Deploy the smart contract 

```py smart_contract_deploy.py focus=38:40

```
---
Wait for the transaction receipt

```py smart_contract_deploy.py focus=41:42
