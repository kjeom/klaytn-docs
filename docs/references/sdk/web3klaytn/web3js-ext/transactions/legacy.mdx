...
```js txTypeLegacyTransaction.js focus=9:10
...
```js txTypeLegacyTransaction.js focus=20

```
---
The **sendSignedTransaction** method send transaction signed into blockchain.

```js txTypeLegacyTransaction.js focus=23:24
...
```js txTypeLegacyTransaction.js focus=26:27
